...
import os
import sys
sys.path.insert(0, os.path.abspath('../xesmf'))
...
latex_documents = [
    (master_doc, 'xESMF.tex', 'xESMF Documentation',
...
man_pages = [
    (master_doc, 'xesmf', 'xESMF Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xESMF', 'xESMF Documentation',
     author, 'xESMF', 'One line description of project.',
     'Miscellaneous'),
]
